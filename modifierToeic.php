								...
								for($i=1 ; $i <= 100 ; $i++){ // pour chaque question on recupere la valeur qui avait ete enregistree precedemment
									...
									<div class="form-group row questions" style="display:flex;margin-right:0px;margin-left:0px;"> 
										...
										<div style="display:inline-block" class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="question',$i,'" id="grp',$i,'AM" value=A ',$a,' required>
											<label class="form-check-label col-form-label" for="grp',$i,'AM">A</label>
										</div>
										<div style="display:inline-block" class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="question',$i,'" id="grp',$i,'BM" value=B ',$b,' required>
											<label class="form-check-label col-form-label" for="grp',$i,'BM">B</label>
										</div>
										<div style="display:inline-block" class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="question',$i,'" id="grp',$i,'CM" value=C ',$c,' required>
											<label class="form-check-label col-form-label" for="grp',$i,'CM">C</label>
										</div>
										<div style="display:inline-block" class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="question',$i,'" id="grp',$i,'DM" value=D ',$d,' required>
											<label class="form-check-label col-form-label" for="grp',$i,'DM">D</label>
										</div>
									</div>';
								}
							?>
...
<?php } 
	...
	// Affiche un message d'erreur on de réussite
